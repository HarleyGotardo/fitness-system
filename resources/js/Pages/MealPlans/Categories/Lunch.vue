...
<template>
    <Head title="Lunch - Fiber Muscle" />

    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Meal Plans: Lunch</h2>
            </div>
        </template>
        ...
        <div class="flex flex-col space-y-4 p-4 m-20">
            ...
            <div v-if="lunch.length === 0" class="text-center text-gray-500">
